    ...
    <template v-else-if="!queried">
      <div class="page-card">
        <EmptyState
          ...
          title="请先选择科目和考试类型后查询"
          description="选择筛选条件并点击查询按钮，即可查看科目统计信息"
        />
      </div>
    </template>
...
import { Download, Search, RefreshRight, Collection, User, TrendCharts, CircleCheck, DataLine, Odometer, CircleCloseFilled } from '@element-plus/icons-vue'
